...
template <typename T>
class UnstackOpModel : public SingleOpModel {
 public:
  UnstackOpModel(const TensorData& input, int axis) {
    ...
    SetBuiltinOp(BuiltinOperator_UNSTACK, BuiltinOptions_UnstackOptions,
                 CreateStackOptions(builder_, num_outputs, axis).Union());
...
// float32 tests.
TEST(UnstackOpTest, FloatThreeOutputs) {
  UnstackOpModel<float> model({TensorType_FLOAT32, {3, 2}}, 0);
...
TEST(UnstackOpTest, FloatThreeOutputsAxisOne) {
  UnstackOpModel<float> model({TensorType_FLOAT32, {3, 2}}, 1);
  model.SetInput({1, 2, 3, 4, 5, 6});
  model.Invoke();
...
TEST(UnstackOpTest, FloatOneOutput) {
  UnstackOpModel<float> model({TensorType_FLOAT32, {1, 6}}, 0);
  model.SetInput({1, 2, 3, 4, 5, 6});
  model.Invoke();
...
TEST(UnstackOpTest, FloatThreeDimensionsOutputs) {
  UnstackOpModel<float> model({TensorType_FLOAT32, {2, 2, 2}}, 2);
...
// int32 tests.
TEST(UnstackOpTest, IntThreeOutputs) {
  UnstackOpModel<int32_t> model({TensorType_INT32, {3, 2}}, 0);
  model.SetInput({1, 2, 3, 4, 5, 6});
  model.Invoke();
...
TEST(UnstackOpTest, IntThreeOutputsAxisOne) {
  UnstackOpModel<int32_t> model({TensorType_INT32, {3, 2}}, 1);
  model.SetInput({1, 2, 3, 4, 5, 6});
  model.Invoke();
...
TEST(UnstackOpTest, IntOneOutput) {
  UnstackOpModel<int32_t> model({TensorType_INT32, {1, 6}}, 0);
  model.SetInput({1, 2, 3, 4, 5, 6});
  model.Invoke();
...
TEST(UnstackOpTest, IntThreeDimensionsOutputs) {
  UnstackOpModel<int32_t> model({TensorType_INT32, {2, 2, 2}}, 2);
  model.SetInput({1, 2, 3, 4, 5, 6, 7, 8});
  model.Invoke();
